...
def _runtime_snapshot(conversation_id: str) -> dict[str, Any]:
    return {
        ...
        "routing": {
            ...
            "candidate_limit": agent_runtime.TOOL_ROUTING_CANDIDATES,
            "auto_activate_threshold": agent_runtime.TOOL_ROUTING_AUTO_THRESHOLD,
            "auto_activate_margin": agent_runtime.TOOL_ROUTING_AUTO_MARGIN,
            "min_candidate_score": agent_runtime.TOOL_ROUTING_MIN_SCORE,
