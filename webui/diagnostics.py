...
def _runtime_snapshot(conversation_id: str) -> dict[str, Any]:
    return {
        ...
        "models": {
            "all_purpose": agent_runtime.MODEL,
            "system1_router": agent_runtime.ROUTER_MODEL,
        },
        ...
        "routing": {
            "model": agent_runtime.ROUTER_MODEL,
            "options": agent_runtime.ROUTER_OPTIONS,
            "candidates": agent_runtime.ROUTER_CANDIDATES,
            "route_threshold": agent_runtime.ROUTER_ROUTE_THRESHOLD,
            "timeout_seconds": agent_runtime.ROUTER_TRANSPORT_TIMEOUT,
            "prefix_max_bytes": agent_runtime.ROUTER_PREFIX_MAX_BYTES,
            "description_chars": agent_runtime.ROUTER_DESCRIPTION_CHARS,
            "prefix_cache": get_monitor_state("agent.router_cache", {}),
