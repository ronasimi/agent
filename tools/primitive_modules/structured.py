...
def json_query(path_expr: str = "$", data: str = "", path: str = "") -> str:
...
def json_filter(key: str, operator: str, value: str, data: str = "", path: str = "", limit: int = 200) -> str:
...
def json_sort(key: str, data: str = "", path: str = "", descending: bool = False, limit: int = 200) -> str:
...
def json_diff(a: str, b: str) -> str:
    """Compare two JSON values and return added/removed/changed paths."""
    try:
        left=json.loads(a); right=json.loads(b); changes=[]
...
def json_head(data: str = "", path: str = "", count: int = 10) -> str:
...
def json_count(data: str = "", path: str = "") -> str:
...
def compare_json(a: str, b: str) -> str:
