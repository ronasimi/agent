...
def environment_summary() -> str:
    ...
    payload = {
        ...
        "pid": os.getpid(),
        "executor_model": str(agent_cfg.get("executor_model") or agent_cfg.get("model") or ""),
        "decision_model": str(agent_cfg.get("decision_model") or ""),
        "reasoning_model": str(agent_cfg.get("reasoning_model") or ""),
        "vision_model": str(agent_cfg.get("vision_model") or ""),
        "research_model": str(agent_cfg.get("report_model") or ""),
