...
_PARAMETER_HINTS = {
    ...
    "start_time": "Inclusive UTC lower timestamp bound for historical chat search (YYYY-MM-DD HH:MM:SS or ISO-8601).",
    "end_time": "Exclusive UTC upper timestamp bound for historical chat search (YYYY-MM-DD HH:MM:SS or ISO-8601).",
    "conversation_id": "Optional saved conversation identifier; empty searches across conversations.",
