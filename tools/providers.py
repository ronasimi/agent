...
ALWAYS_TOOL_NAMES = {'read_file', 'current_time'}

TOOL_BUNDLES = (
    ({'repo', 'script', 'project', 'python', 'file', 'files', 'coding', 'code'},
     ('read_file', 'path_stat', 'list_directory', 'find_paths', 'read_text', 'tail_file', 'file_hash', 'mime_type', 'text_search', 'regex_extract', 'json_query', 'run_pipeline', 'get_repo_map', 'search_repo_symbols', 'repo_status', 'repo_diff', 'repo_checks')),
    ...
    ({'media', 'images', 'photo', 'screenshots', 'vision', 'image', 'screenshot', 'picture', 'visual'},
    ...
    ({'host', 'command', 'shell', 'cpu', 'disk', 'system', 'log', 'process', 'gpu', 'ram'},
     ('host_snapshot', 'process_snapshot', 'pressure_snapshot', 'filesystem_snapshot', 'service_health', 'kernel_info', 'memory_info', 'load_average', 'uptime', 'mounts', 'block_devices', 'temperature_sensors', 'list_processes', 'process_info', 'read_host_file', 'read_host_journal', 'tail_host_log', 'read_observation')),
