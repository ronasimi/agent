...
TOOL_BUNDLES = (
    ...
    ({'dns', 'mdns', 'network', 'wifi', 'lan', 'route', 'port'},
     ('network_snapshot', 'neighbor_snapshot', 'connection_snapshot', 'network_reachability', 'dns_diagnose', 'network_path', 'endpoint_probe', 'http_probe', 'map_network', 'scan_mdns', 'resolve_host', 'route_lookup', 'tcp_connect', 'tls_handshake', 'ping_host', 'http_request', 'interface_list', 'interface_info', 'neighbor_list', 'socket_list')),
